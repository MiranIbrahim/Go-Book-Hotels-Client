            ...
            <div className="hero max-h-screen mt-5 bg-base-100">
                <div className="hero-content grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className=''>
                        ...
                        data-aos-duration="1500" className=" text-2xl md:text-5xl text-primary font-bold">We Provide the Best Hotels Worldwide!</h1>
                        ...
                        data-aos-duration="1000" data-aos-delay="1000" to='/rooms' className='btn btn-primary'>Explore more</Link>
                    </div>
