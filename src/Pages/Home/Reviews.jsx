...
const Reviews = () => {
    ...
    return (
        <section className='my-20 md:my-32'>
            <h2 className='text-center text-lime-500 font-extrabold text-3xl md:text-4xl'>Our Clients Around The World</h2>
            <h5 className='text-center font-bold text-blue-400 text-lg md:text-2xl mt-3'>Our Client’s Speak</h5>
            ...
            <div className='grid grid-cols-1 my-10 md:grid-cols-3 px-2 gap-6 font-bold'>
                    ...
                    <div className="card bg-blue-400 text-white hover:bg-success transition ease-in-out duration-1000">
                        <div className="card-body text-center">
                            ...
                            <p className='text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos provident cum exercitationem eos rerum recusandae temporibus delectus vitae veritatis illo? Ex voluptatum nulla odio corrupti molestias itaque sequi voluptatibus dolores saepe.</p>
